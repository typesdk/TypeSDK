...
public class MainActivity extends BaseMainActivity implements onAccountResult,onPayResult{
...
protected void onActivityResult(int requestCode, int resultCode, Intent data) {
	...
	TypeSDKBonjour.Instance().onActivityResult(requestCode, resultCode, data,RESULT_OK);
	
}
    
	@Override
	public void onPay(int arg0, Intent arg1) {
		
	}

	@Override
	public void onAccount(int arg0, Intent arg1) {
