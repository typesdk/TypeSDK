...
public class TypeSDKNotify_KP
{
		public void sendToken(String userToken ,String userOpenID)
		{
			// TODO Auto-generated method stub
//			String userToken = _token_string;
//			TypeSDKLogger.i("login success intent extra:userToken" + userToken);
//			TypeSDKLogger.i("login success intent extra:userID" + userId);
		
			TypeSDKData.UserInfoData userData = new TypeSDKData.UserInfoData();
			userData.SetData(AttName.USER_TOKEN, userToken);
			userData.SetData(AttName.USER_ID, userOpenID);
