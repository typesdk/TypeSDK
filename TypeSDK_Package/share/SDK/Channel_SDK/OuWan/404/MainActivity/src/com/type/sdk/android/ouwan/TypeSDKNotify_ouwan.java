...
public class TypeSDKNotify_ouwan {
		public void sendToken(String _token_string, String _uid_string, String timestamp_string)
		{
			...
			userData.SetData(TypeSDKDefine.AttName.TIMESTAMP, timestamp);
