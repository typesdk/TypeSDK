...
//		SharedPreferencesUtil sh = new SharedPreferencesUtil(_in_context, "ucStance");
//		String ds_appid = sh.read(AttName.APP_ID);
//		if(ds_appid == null || ds_appid.isEmpty()){
//			SendEvent.appActivation(SDK.getInstance());
//			sh.save(AttName.APP_ID, TypeSDKBonjour_UC.Instance().platform.GetData("ds_appid"));
//		}
