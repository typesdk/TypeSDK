...
public class TypeSDKNotify_PocketBus
{
		public void sendToken(String _token_string, String _uid_string, String _username_string)
		{
			// TODO Auto-generated method stub
			String userToken = _token_string;
			String uid = _uid_string;
			String username = _username_string;
			...
			userData.SetData(TypeSDKDefine.AttName.USER_NAME, username);
		...
		public void reLogin(String _token_string, String _uid_string, String _username_string)
		{
			TypeSDKLogger.i("user sdk reLogin");		
			String userToken = _token_string;
			String uid = _uid_string;
			String username = _username_string;
			TypeSDKLogger.i("reLogin success:" + userToken);
			...
			TypeSDKEventManager.Instance().SendEvent(EventType.AND_EVENT_RELOGIN,
					ReceiveFunction.MSG_RELGOIN, userData.DataToString(), 
