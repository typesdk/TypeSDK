...
import com.type.sdk.android.tencent.YSDKCallback;
import com.type.sdk.android.tencent.TypeSDKBonjour;
...
public class TypeSDKHelper {
	...
	public static void onCreate(Activity activity, Context context) {
		...
		YSDKCallback.localContext = context;
	...
	public static void onDestroy(Activity activity) {
		...
		TypeSDKBonjour.isCallLogin = false;
		YSDKApi.onDestroy(activity);
	}

	public static void onResume(Activity activity) {
		//TypeSDKBonjour.Instance().onResume(activity);
		if(TypeSDKBonjour.isEnterLogin){
			TypeSDKLogger.i("onResume;isEnterLogin:"+String.valueOf(TypeSDKBonjour.isEnterLogin));
			TypeSDKBonjour.isEnterLogin = false;
			TypeSDKBonjour.isLoginFinish = true;
		}
