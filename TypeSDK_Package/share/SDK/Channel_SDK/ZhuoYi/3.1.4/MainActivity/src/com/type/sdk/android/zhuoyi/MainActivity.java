...
public class MainActivity extends BaseMainActivity{
    ...
    //重写Activity的onConfigurationChanged(Configuration newConfig)方法，并调用ZYGameManager.onConfigurationChanged(Context context)方法。
    @Override
	public void onConfigurationChanged(Configuration newConfig) {
		super.onConfigurationChanged(newConfig);
		ZYGameManager.onConfigurationChanged(MainActivity.this);
	}
