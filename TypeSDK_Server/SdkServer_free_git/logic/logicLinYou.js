...
function convertParamLogin(query,ret)
{
    ...
    ret.data = unescape(cloned.token);
...
function callChannelLogin(attrs,params,query,ret,retf)
{
    ...
    var options = {
        url: params.out_url,// out_url_test测试环境   out_url //正式环境
...
function checkSignPay(attrs,query)
{
    var str = query.game +
        ...
        query.payChannel +
        query.payExt;
    //str = logicCommon.utf16to8(str) +"#"+ attrs.secret_key
